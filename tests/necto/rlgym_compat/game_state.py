...
class GameState:
    ...
    def decode(self, packet: flat.GameTickPacket, ticks_elapsed=1):
    ...
    def _decode_player(
        ...
        player_data.has_jump = player_info.air_state != flat.AirState.Jumping
        # RLGym does consider the timer/unlimited flip, but i'm to lazy to track that in rlbot
        player_data.has_flip = player_info.air_state != flat.AirState.DoubleJumping
